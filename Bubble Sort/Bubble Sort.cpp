...
int n;	//deklarasi variabel dn untuk menyimpan banyaknya elemen pada array


void input() { //procedure untuk input
	while (true) { //looping
		cout << "masukkan banyaknya elemen pada array : "; //output ke layar
		cin >> n; //input dati pengguna
...
void display() { //procedure untuk menampilkan hasil
	...
	cout << "================================" << endl; //output ke layar
	for (int j = 0; j < n; j++) { //looping dfengan j dimulai dari 0 hingga n-1
